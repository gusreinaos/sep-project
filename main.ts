...
const productionManagerMenu = new ProductionManagerMenu(getAvailableStaff, getAllStaff, getAssignedRequests, redirectRequest, userRepository, updateRequestByStatus, createStaffRequest, requestRepository, getAssignedStaffRequests);
